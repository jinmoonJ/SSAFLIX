    ...
    <div v-if="isLogin">
      <div id="nav">
        <b-navbar toggleable="lg" type="dark" variant="dark" class="ml-5 mr-5">
          <b-icon variant="warning" icon="badge-hd-fill" animation="fade" font-scale="2" class="mr-3"></b-icon>
          <b-navbar-brand href="#"><router-link :to="{ name: 'Home' }" class="text-white font-weight-bold" style="font-family: cursive;">MovieRecommend</router-link></b-navbar-brand>
          ...
          <b-collapse id="nav-collapse" is-nav>
            ...
            <b-navbar-nav class="ml-auto">
              ...
              <b-nav-item-dropdown right id="dropdown">
                ...
                <b-dropdown-item @click.native="toProfile" href="#">Profile</b-dropdown-item>
